package com.obyte.alcohol.fragment.shop;
...
public class ShopFragment extends Fragment {
    ...
    public void initWebView(ViewGroup viewGroup){
        ...
        mWebView.loadUrl("https://www.coupang.com/np/search?q=%EC%A0%84%ED%86%B5%EC%A3%BC&channel=recent"); // 웹뷰에 표시할 웹사이트 주소, 웹뷰 시작
